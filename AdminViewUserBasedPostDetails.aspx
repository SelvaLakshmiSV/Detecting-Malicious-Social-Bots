<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AdminViewUserBasedPostDetails.aspx.cs" Inherits="AdminViewUserBasedPostDetails" %>
...
<tr>
<th><h1>User Based Post Details</h1></th>
</tr>
<tr>
...
<center>
    ...
    <asp:ButtonField Text ="Comment" HeaderText ="View Comment" CommandName ="vc2" ControlStyle-ForeColor ="Green" ControlStyle-Font-Bold ="true" />
    <asp:ButtonField Text ="Like" HeaderText ="View Like" CommandName ="vl" ControlStyle-ForeColor ="Green" ControlStyle-Font-Bold ="true" />
...
<center>
    ...
    <asp:ButtonField Text ="Delete" HeaderText ="Delete Comment" CommandName  ="dc"  ControlStyle-ForeColor ="Green" ControlStyle-Font-Bold ="true" />
    </Columns>
        <FooterStyle BackColor="#CCCCCC" />
        <HeaderStyle BackColor="Black" Font-Bold="True" ForeColor="White" />
        <PagerStyle BackColor="#CCCCCC" ForeColor="Black" HorizontalAlign="Left" />
...
<td style ="text-align :center ;">
   <center>View Like<br />
    ...
    <asp:ButtonField Text ="Delete" HeaderText ="Delete Like"  CommandName ="dl"  ControlStyle-ForeColor ="Green" ControlStyle-Font-Bold ="true" />
    </Columns>
        <FooterStyle BackColor="#CCCCCC" />
        <HeaderStyle BackColor="Black" Font-Bold="True" ForeColor="White" />
        <PagerStyle BackColor="#CCCCCC" ForeColor="Black" HorizontalAlign="Left" />
